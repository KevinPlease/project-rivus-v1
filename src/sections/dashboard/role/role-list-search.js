...
export const RoleListSearch = ({ handleFiltersChange, formDetails }) => {
  ...
  useOnceEffect(() => {
    if (gridFilters.current !== "role") return;

    setUserInput(gridFilters.filters.name || "");
  }, [formDetails]);
