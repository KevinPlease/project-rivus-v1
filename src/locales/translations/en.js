...
export const en = {
  ...
  [tokens.nav.propertyList]: 'Properties',
  [tokens.nav.opportunity]: 'Opportunity',
  ...
  [tokens.nav.customerDetails]: 'Customer Details',
  [tokens.nav.add]: 'Add',
  [tokens.nav.customer]: 'Customer',
  [tokens.nav.customers]: 'Customers',
  [tokens.nav.customerDetails]: 'Customer Details',
  ...
  [tokens.nav.overview]: 'Overview',
  [tokens.nav.property]: 'Property',
  [tokens.nav.properties]: 'Properties',
  [tokens.nav.propertyDetails]: 'Property Details',
  [tokens.nav.unit]: 'Unit',
  [tokens.nav.units]: 'Units',
  [tokens.nav.unitDetails]: 'Unit Details',
  [tokens.nav.administration]: 'Administration',
  [tokens.nav.users]: 'Users',
  [tokens.nav.user]: 'User',
  [tokens.nav.userDetails]: 'User Details',
  [tokens.nav.role]: 'Role',
  [tokens.nav.roles]: 'Roles',
  [tokens.nav.roleDetails]: 'Role Details',
};
